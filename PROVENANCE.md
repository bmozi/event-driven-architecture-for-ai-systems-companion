...
- **Content status:** blank tools, transparently constructed examples, bounded
  experiment references, and unrun practitioner materials retain their labels
...
- **Use:** Align `TERMS.md` with the repository's CC BY 4.0 content license and
  Apache 2.0 code license without changing legitimate template-maturity or
